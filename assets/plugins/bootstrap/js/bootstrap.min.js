...
!function(t, e) {
    ...
    class at extends q {
        constructor(t, e) {
            super(),
            this._element = t,
            t && at.isSupported() && (this._config = this._getConfig(e),
            this._deltaX = 0,
        ...
        _initEvents() {
            this._supportPointerEvents ? (j.on(this._element, st, (t=>this._start(t))),
    ...
    class Ot extends W {
        ...
        _addEventListeners() {
            ...
            "hover" === this._config.pause && (j.on(this._element, pt, (()=>this.pause())),
    ...
    class we extends q {
        ...
        hide(t) {
            this._config.isVisible ? (this._getElement().classList.remove(pe),
            this._emulateAnimation((()=>{
                this.dispose(),
                v(t)
            }
        ...
        dispose() {
            this._isAppended && (j.off(this._element, be),
            this._element.remove(),
            this._isAppended = !1)
        }
        _getElement() {
    ...
    class Ue extends W {
        ...
        hide() {
            this._isShown && !this._isTransitioning && (j.trigger(this._element, xe).defaultPrevented || (this._isShown = !1,
            this._isTransitioning = !0,
        ...
        _triggerBackdropTransition() {
            ...
            "hidden" === e || this._element.classList.contains(Qe) || (t || (this._element.style.overflowY = "hidden"),
    ...
    class gi extends W {
        ...
        hide() {
            this._isShown && (j.trigger(this._element, ri).defaultPrevented || (this._focustrap.deactivate(),
            this._element.blur(),
            this._isShown = !1,
    ...
    class Ni extends W {
        ...
        hide() {
            if (this._isShown() && !j.trigger(this._element, this.constructor.eventName("hide")).defaultPrevented) {
                if (this._getTipElement().classList.remove(Ti),
                "ontouchstart"in document.documentElement)
                    for (const t of [].concat(...document.body.children))
                        j.off(t, "mouseover", _);
    ...
    class Qi extends W {
        ...
        _maybeEnableSmoothScroll() {
            this._config.smoothScroll && (j.off(this._config.target, zi),
    ...
    class Is extends W {
        ...
        show() {
            j.trigger(this._element, Cs).defaultPrevented || (this._clearTimeout(),
        ...
        hide() {
            this.isShown() && (j.trigger(this._element, As).defaultPrevented || (this._element.classList.add(Ss),
            this._queueCallback((()=>{
